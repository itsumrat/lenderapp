...
Route::group(array('middleware' => 'auth'), function() {
    ...
    Route::get('/borrowers/invoice/view/{id}', 'App\Http\Controllers\BorrowersController@viewInvoice');
	 ...
	 Route::post('/borrowers/default/mail', 'App\Http\Controllers\BorrowersController@maildefault')->name('borrowers.mail.default');
	Route::get('/borrowers/{borrower_id}/mail/{id}', 'App\Http\Controllers\BorrowersController@mail')->name('borrower.mail');
    ...
    Route::get('/settings', 'App\Http\Controllers\SettingController@settings');
    Route::post('/settings', 'App\Http\Controllers\SettingController@settingsSubmit');
    
    Route::get('/gift-ads', 'App\Http\Controllers\SettingController@giftAds');
    Route::post('/gift-ads', 'App\Http\Controllers\SettingController@giftAdsSubmit');
