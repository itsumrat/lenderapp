         ...
         <div>
            ...
            <div class="zb-txn-form">
                  ...
                  <div class="form-group row">
                     <label class="col-form-label col-lg-2 required">Invoice No.</label>  
                        <div class="table-container col-lg-4">
                            <input class="ember-text-field ember-view form-control" value="DI/{{date('dmy')}}/{{$bi_no}}" placeholder="Invoice Number" name="invoice_no" type="text" required />
                        </div>
                     <div> </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-form-label col-lg-2 required">Amount Paid</label>  
                        <div class="table-container col-lg-4">
                            <input id="ember430" class="ember-text-field ember-view form-control" onkeyup="javascript:checkNumber2('ember430')" placeholder="Amount Paid" name="amount" type="text" required />
                        </div>
                     <div> </div>
                  </div>
                  <div class="form-group row">
                     ...
                     <div class="col-lg-4">
                        <input placeholder="dd MMM yyyy" id="ember433" class="ember-text-field zf-date-picker date-picker ember-view form-control" data-integrity="date" type="date" name="payment_dt" required />  
                     </div>
                  </div>
                  <div class="form-group row">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-lg-6"><textarea rows="2" placeholder="Let your customer know what this Invoice is for" maxlength="130" id="ember438" class="ember-text-area ember-view form-control" name="subject"  style="resize:none;"></textarea></div>
               </div>
            </div>
                  ...
                  <div class="row seperator-col">
                     <div class="col-lg-8 coll">
                        <div class="form-group">
                           ...
                           <div>
                              <textarea rows="4" placeholder="Enter the Remarks/Payment Notes of your payment invoice to be displayed in your transaction" id="ember516" class="ember-text-area ember-view form-control" name="note" style="resize:none;" maxlength="255"></textarea>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        ...
                        <div>
                            ...
                            <input id="a38957d1b" name="is_receive" value="1" class="ember-checkbox ember-view form-check-input" type="checkbox"> &nbsp; 
