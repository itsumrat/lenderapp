...
<div id="ember772" class="flyout ember-view flyout-sm" style="display:none">
   <div id="ember773" class="flyout-header ember-view">
      <div class="section header">
         <a href="javascript:rightPanelSet();" class="close-details">
         ...
         <h4 class="text-semibold">Donor Details</h4>
      </div>
   </div>
         ...
         <div class="float-left">
            <div>
               ...
               <span id="ember776" class="tooltip-container ember-view">
                  <a target="_blank" rel="noreferrer noopener" href="{{url('donors/view/'.$info__->id)}}" class="ember-view">
      ...
      <div class="p-5">
         ...
         <div id="ember778" class="ember-view accord-title-arrow pt-5">
            ...
            <div id="ember780" class="ember-view collapse show" style="">
               <div class="row pt-5">
                  <label class="col-lg-5 text-muted"> Donor Type </label> 
         ...
         <div>
            <div class="primary-info grey-bg">
               <div class="zb-txn-form">
                  <div class="form-group">
                     <div class="row">
                        <label class="col-form-label col-lg-2 required">Donor Name</label> 
                        <div class="col-lg-6">
                           <div id="ember417" class="ember-view" data-integrity="customer_id">
                              <div class="ac-box ">
                                 <span class="ac-selected form-control " tabindex="0">
                                    <span>
                                        {{ucwords($info__ -> first_name." (".$info__ -> sur_name.")")}} : {{$info__ -> reg_no}}
                                    </span>
                                    <div>
                     ...
                     <div class="row">
                        <div class="col-lg-10 offset-lg-2">
                           <div id="ember421" class="ember-view info-item cursor-pointer">
                              <a href="javascript:rightPanelSet();" class="btn-link">
                           ...
                           <div class="col-lg-8">
                              <div id="ember425" class="popovercontainer address-group ember-view">
                                 <div id="ember752" class="ember-view">
                                    <div id="ember753" class="ember-view">
                                       <div class="address-list">
                                          <div>
                                            <span data-ember-action="" data-ember-action-754="754"> 
                                                <span class="text-muted text-uppercase font-small"><span>Billing Address</span>
                                                &nbsp;&nbsp;
                                                <span class="text-blue font-xxs cursor-pointer" href="#">Change</span></span>
                                            </span>
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <address id="ember427" class="text-muted font-small ember-view">
                                    <strong>{{$info__ -> address1}}</strong> 
                                    @if(strlen($info__ -> address2)>0)<div class="preserve-wrap">{{$info__ -> address2}}</div>@endif
            ...
            <div class="zb-txn-form">
                  ...
                  <div class="form-group row">
                     <label class="col-form-label col-lg-2 required">Invoice No.</label>  
                        <div class="table-container col-lg-4">
                            <input class="ember-text-field ember-view form-control" value="{{$bi__ -> invoice_no}}" disabled type="text" />
                        </div>
                     <div> </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-form-label col-lg-2 required">Amount Received</label>  
                        <div class="table-container col-lg-4">
                            <input id="ember430" class="ember-text-field ember-view form-control" onkeyup="javascript:checkNumber2('ember430')" placeholder="Amount Received" name="amount" value="{{$bi__ -> amount}}" type="text" required />
                        </div>
                     <div> </div>
                  </div>
                  <div class="form-group row">
                     ...
                     <div class="col-lg-4">
                        <input placeholder="dd MMM yyyy" id="ember433" class="ember-text-field zf-date-picker date-picker ember-view form-control" data-integrity="date" type="date" name="payment_dt" value="{{$bi__ -> payment_dt}}" required />  
                     </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-form-label col-lg-2 required">Payment Mode</label> 
                     <div class="col-lg-4"> 
                        <select class="ember-text-field ember-view form-control" name="payment_mode" required >
                            @foreach( $payment__ AS $list )
                                <option value="{{$list->name}}" @if($bi__ -> payment_mode==$list->name) selected @endif />{{$list->name}}
                            @endforeach
                        </select>
                     </div>
                  </div>
               ...
               <div class="form-group row">
                  ...
                  <div class="col-lg-6"><textarea rows="2" placeholder="Let your customer know what this Invoice is for" maxlength="130" id="ember438" class="ember-text-area ember-view form-control" name="subject"  style="resize:none;">{{$bi__ -> subject}}</textarea></div>
               </div>
            </div>
               ...
               <div class="zb-txn-form">
                  <div class="row seperator-col">
                     <div class="col-lg-8 coll">
                        <div class="form-group">
                           <div class="mb-2">Remarks / Payment Notes (optional)</div>
                           <div>
                              <textarea rows="4" placeholder="Enter the Remarks/Payment Notes of your payment invoice to be displayed in your transaction" id="ember516" class="ember-text-area ember-view form-control" name="note" style="resize:none;" maxlength="255">{{$bi__ -> note}}</textarea>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-4 coll">
                        <div id="ember517" class="form-group ember-view">
                           ...
                           <div><span class="font-xs">Attach File to Invoice</span></div>
                           <div id="ember518" class="dropdown ember-view btn-group mt-2">
                            ...
                            @if(strlen($bi__->attachment)>0)
                                <a href="{{url('/storage/app/public/landers/invoice/'.$bi__ -> attachment)}}" target="_blank">
                                    <img src="{{Request::root()}}/storage/app/public/landers/invoice/{{$bi__ -> attachment}}" alt="Attachment" style="height:80px"/>
                                </a>
                            @endif
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        ...
                        <div>
                            ...
                            <input id="a38957d1b" name="is_receive" value="1" class="ember-checkbox ember-view form-check-input" type="checkbox" @if($bi__ -> is_receive=="yes") checked="checked" @endif > &nbsp; 
                            <label for="a38957d1b" class="form-check-label">
                                <span class="text-bold"> I have received the payment </span></label> 
                            </label>
                        </div>
                     </div>
                  </div>
               ...
               <div class="form-group">
                  ...
                  <div class="font-small">
                     <div class="form-check form-check-inline cf-label"> 
                        <input id="a98990017" class="ember-checkbox ember-view form-check-input" name="is_mail" value="1" type="checkbox"  @if($bi__ -> is_mail=="yes") checked="checked" @endif > 
                        <label for="a98990017" title="{{$info__->email_address}}" class="form-check-label">
                            {{$info__->first_name}} ({{$info__->sur_name}}) <&nbsp;{{$info__->email_address}}&nbsp;>
                        </label> 
                    </div>
                     <!--
            ...
            <div class="zb-txn-form">
               ...
               <div class="btn-toolbar  fixed-actions fill-container">
                  ...
                  <div class="btn-group">
                    <a href="{{url('landers/view')}}/{{$info__->id}}" class="btn btn-primary">Cancel</a>
                  </div>
