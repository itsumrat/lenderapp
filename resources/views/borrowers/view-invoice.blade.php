         ...
         <div>
                        ...
                        <div id="ember517" class="form-group ember-view">
                           ...
                           <div id="ember518" class="dropdown ember-view btn-group mt-2">
                            ...
                            @if(strlen($bi__->attachment)>0)
                                <a href="{{url('/storage/app/public/borrowers/invoice/'.$bi__ -> attachment)}}" target="_blank">
                                    <img src="{{Request::root()}}/storage/app/public/borrowers/invoice/{{$bi__ -> attachment}}" alt="Attachment" style="height:80px"/>
                                </a>
                            @endif
            ...
            <div class="zb-txn-form">
               ...
               <div class="btn-toolbar  fixed-actions fill-container">
                  ...
                  <div class="btn-group">
                    <a href="{{url('borrowers/view')}}/{{$info__->id}}" class="btn btn-primary">Cancel</a>
                  </div>
