                  ...
                  <div class="form-group row">
                     <label class="col-form-label col-lg-2 required">Invoice No.</label>  
                        <div class="table-container col-lg-4">
                            <input class="ember-text-field ember-view form-control" value="LI/{{date('dmy')}}/{{$bi_no}}" placeholder="Invoice Number" name="invoice_no" type="text" required />
                        </div>
                     <div> </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-form-label col-lg-2 required">Amount</label>  
                        <div class="table-container col-lg-4">
                            <input id="ember430" class="ember-text-field ember-view form-control" onkeyup="javascript:checkNumber2('ember430')" placeholder="Amount" name="amount" type="text" required />
                        </div>
                     <div> </div>
                  </div>
                  <div class="form-group row">
