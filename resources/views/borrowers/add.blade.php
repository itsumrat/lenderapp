...
<div class="scroll-y noscroll-x fill body scrollbox">
  <div class="header">
    <h3 class="float-left">New Lander</h3>
  ...
  <form method="post" action="" enctype="multipart/form-data" class="contact-create">
    ...
    <div class="row zb-txn-form">
      <div class="col-lg-8">
        <div class="row form-group">
          ...
          <div class="col-lg-4">
            <input name="reg_no" class="form-control ember-text-field ember-view" placeholder="Lander's Reg. No." type="text" value="B/{{date('m/y')}}/{{$no}}" required />
          </div>
        </div>
        <div class="row form-group">
          <label class="col-form-label col-lg-3"> Reference No. <span class="text-red">*</span> </label>
          <div class="col-lg-4">
            <input name="ref" class="form-control ember-text-field ember-view" placeholder="Lander's Reference No." type="text" value="{{old('ref')}}" required />
          </div>
        </div>
        <div class="row form-group">
        ...
        <div class="row form-group">
          ...
          <div class="col-lg-8">
            <input name="address1" class="form-control ember-text-field ember-view" placeholder="Address 1" type="text" value="{{old('address1')}}" required />
          </div>
        </div>
        <div class="row form-group">
          <label class="col-form-label col-lg-3"> Address 2 </label>
          <div class="col-lg-8">
            <input name="address2" class="form-control ember-text-field ember-view" placeholder="Address 2" type="text" value="{{old('address2')}}" />
          </div>
        </div>
        <div class="row form-group">
          <label class="col-form-label col-lg-3"> City <span class="text-red">*</span> </label>
          <div class="col-lg-4">
            <input name="city" class="form-control ember-text-field ember-view" placeholder="City" type="text" value="{{old('city')}}" required />
          </div>
        </div>
        <div class="row form-group">
          <label class="col-form-label col-lg-3"> Postcode <span class="text-red">*</span> </label>
          <div class="col-lg-4">
            <input name="postcode" class="form-control ember-text-field ember-view" placeholder="Postcode" type="text" value="{{old('postcode')}}" required />
          </div>
        </div>
        <div class="row form-group">
        ...
        <div class="row form-group">
          ...
          <div class="col-lg-8">
            <input name="email_address" class="form-control ember-text-field ember-view" placeholder="Lander's Email Address" type="email" value="{{old('email_address')}}" required />
          </div>
        </div>
        <div class="row form-group">
          <label class="col-form-label col-lg-3"> Loan Amount <span class="text-red">*</span> </label>
          <div class="col-lg-4">
            <input name="loan_amount" value="{{old('loan_amount')}}" class="form-control ember-text-field ember-view" placeholder="Loan Amount" type="text" required />
          </div>
        </div>
        <div class="row form-group">
          <label class="col-form-label col-lg-3"> Total Repay <span class="text-red">*</span> </label>
          <div class="col-lg-4">
            <input name="repay" value="{{old('repay')}}" class="form-control ember-text-field ember-view" placeholder="Total Repay" type="text" required />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="tab-content">
      <div class="tab-pane active">
        ...
        <div class="row">
          <div class="col-lg-12"> <a href="javascript:addMoreCommunication();">+ Add Archive</a> </div>
        </div>
        <!----> 
      </div>
      <div class="tab-pane ">
    ...
    <div class="btn-toolbar fixed-actions fill-container">
      ...
      <button class="btn btn-primary ember-view" type="submit"> Save </button>
		<?php } ?>
